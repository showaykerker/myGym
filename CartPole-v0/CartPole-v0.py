...
class DQNCartPoleSolver():
    def __init__(self, n_episodes=1000, n_win_ticks=195, max_env_steps=None, gamma=1.0, epsilon=1.0, epsilon_min=0.01,
                 epsilon_log_decay=0.937, alpha=0.01, alpha_decay=0.01, batch_size=64, monitor=False, quiet=False):
        ...
        self.model.add(Dense(144, activation='tanh', kernel_initializer='glorot_normal', bias_initializer='glorot_normal'))
